...
public class BookProvider extends ContentProvider {
    ...
    // SQLite Query Method to retrieve data from database either for Main Activity (entire table) or
    // for a single book (single row)
    @Nullable
    @Override
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
        ...
        switch (match) {
            ...
            case BOOK_ID:
                ...
                // SQLite query method using parameters to retrieve a single row
                cursor = database.query(BookEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            default:
        ...
        // so we know content URI the cursor was created for.
    ...
    /* Helper method for inserting a book */
        private Uri insertBook(Uri uri, ContentValues values) {
            ...
            if ((quantity < 0 && quantity != null) || quantity == null) {
            ...
            // Variable holding return value from insert method.
            long id = 0;
            ...
            if (id == -1) {
                Log.e("BookProvider insertBook", "Failed to insert row for " + uri);
                return null;
            }
